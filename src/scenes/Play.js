class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.fastShip01 = new FastSpaceship(this, game.config.width + borderUISize*7,  borderPadding*6 + borderPadding*4, 'spaceship-fast', 0, 40).setOrigin(0,0)
        ...
        this.timeElapsed = 0
        this.timeLeft = this.add.text(config.width/2 + borderUISize + borderPadding, borderUISize + borderPadding*2, game.settings.gameTimer, timeConfig)
